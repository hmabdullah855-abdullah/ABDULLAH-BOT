...
function loadLocalFiles() {
  ...
  if (fs.existsSync('./lib/abdullah.html')) {
...
async function getProfilePicture(sock, jid) {
  try {
    ...
    return 'https://mhcloud.kesug.com/images/abdullahpic.jpg'; // Default image
  }
}
...
async function connectToWA() {
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      const imageUrl = 'https://mhcloud.kesug.com/images/abdullahpic.jpg';
      ...
      for (const participant of participants) {
        ...
        if (action === 'add') {
          ...
          if (settings.goodbye) {
            try {
              // Get user's profile picture
              const ppUrl = await getProfilePicture(sock, participant).catch(() => 'https://mhcloud.kesug.com/images/abdullahpic.jpg');
